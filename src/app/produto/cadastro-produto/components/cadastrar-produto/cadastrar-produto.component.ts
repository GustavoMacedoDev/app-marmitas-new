...
export class CadastrarProdutoComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
              ...
              private opService: OpcaoAtendimentoService
              ) { }
  ...
  ngOnInit(): void {
    ...
    this.opService.listarOpAtendimento().subscribe(res => this.options = res);
  }
  ...
  gerarForm() {
      ...
      restaurante: this.fb.control('', [Validators.required]),
      opcao: this.fb.control('', [Validators.required])
